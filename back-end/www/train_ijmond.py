...
def cv(mode, method, model_path=None, augment=True, perturb=False):
    ...
    if perturb:
        ...
        if mode == "rgb":
            p_frame = "../data/ijmond/rgb_ijmond/"
        elif mode == "rgbd":
            p_frame = "../data/rgbd/"
        elif mode == "flow":
            p_frame = "../data/flow/"
    ...
    model.fit(p_model=model_path[5],
            model_id_suffix="-s5",
            p_metadata_train="../data/ijmond/split_ijmond/metadata_train_split_4_by_camera.json",
            p_metadata_validation="../data/ijmond/split_ijmond/metadata_validation_split_4_by_camera.json",
            p_metadata_test="../data/ijmond/split_ijmond/metadata_test_split_4_by_camera.json")
    # Cross validation on the 4th split by camera
    model.fit(p_model=model_path[4],
            model_id_suffix="-s4",
            p_metadata_train="../data/ijmond/split_ijmond/metadata_train_split_3_by_camera.json",
            p_metadata_validation="../data/ijmond/split_ijmond/metadata_validation_split_3_by_camera.json",
            p_metadata_test="../data/ijmond/split_ijmond/metadata_test_split_3_by_camera.json")
    # Cross validation on the 1st split by camera
    model.fit(p_model=model_path[0],
            model_id_suffix="-s0",
            p_metadata_train="../data/ijmond/split_ijmond/metadata_train_split_0_by_camera.json",
            p_metadata_validation="../data/ijmond/split_ijmond/metadata_validation_split_0_by_camera.json",
            p_metadata_test="../data/ijmond/split_ijmond/metadata_test_split_0_by_camera.json")
    # Cross validation on the 2nd split by camera
    model.fit(p_model=model_path[1],
            model_id_suffix="-s1",
            p_metadata_train="../data/ijmond/split_ijmond/metadata_train_split_1_by_camera.json",
            p_metadata_validation="../data/ijmond/split_ijmond/metadata_validation_split_1_by_camera.json",
            p_metadata_test="../data/ijmond/split_ijmond/metadata_test_split_1_by_camera.json")
    # Cross validation on the 3rd split by camera
    model.fit(p_model=model_path[2],
            model_id_suffix="-s2",
            p_metadata_train="../data/ijmond/split_ijmond/metadata_train_split_2_by_camera.json",
            p_metadata_validation="../data/ijmond/split_ijmond/metadata_validation_split_2_by_camera.json",
            p_metadata_test="../data/ijmond/split_ijmond/metadata_test_split_2_by_camera.json")
    # Cross validation on the split by date
    model.fit(p_model=model_path[3],
            model_id_suffix="-s3",
            p_metadata_train="../data/ijmond/split_ijmond/metadata_train_split_by_date.json",
            p_metadata_validation="../data/ijmond/split_ijmond/metadata_validation_split_by_date.json",
            p_metadata_test="../data/ijmond/split_ijmond/metadata_test_split_by_date.json")
